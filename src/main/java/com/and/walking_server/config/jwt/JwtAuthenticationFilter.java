package com.and.walking_server.config.jwt;
...
import com.and.walking_server.config.auth.PrincipalDetails;
import com.and.walking_server.dto.LoginRequestDto;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {	
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Authentication 의 principalDetails.getUser().getUsername()의 내용: "+principalDetails.getUser().getEmail());
...
//				.withClaim("id", principalDetails.getUser().getUser_id())
    ...
    HMACSHA256(
      ...
      your-256-bit-secret
		...
		cmRequestDto.setEmail(principalDetails.getUser().getEmail());
